...
#                                                    +#+                       #
#    Created: 2023/02/20 12:46:49 by houtworm      #+#    #+#                  #
#    Updated: 2023/02/23 17:57:22 by ewehl         ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
fourargs()
{
	...
	then
		...
		printf "\e[1;31mWrong return value\e[0;00m\n"
		FAULTS=$(($FAULTS+1))
	fi
...
# Test 41
printf "\e[1;36mTest 41: Checking if Makefile bonus rule exists\e[0;00m\n"
...
# Test 42
printf "\e[1;36mTest 42: Checking if Makefile relinks for bonus\e[0;00m\n"
...
# Test 43
printf "\e[1;36mTest 43: Running pipex properly with basic commands\e[0;00m\n"
fiveargs tests/input "cat" "cat" "cat" tests/output
errorclean
sleep $SLEEP

# Test 44
printf "\e[1;36mTest 44: Running pipex with commands with options\e[0;00m\n"
fiveargs tests/input "cat -e" "cat -b" "cat -v" tests/output
errorclean
sleep $SLEEP

# Test 45
printf "\e[1;36mTest 45: Running pipex with commands with multiple options\e[0;00m\n"
fiveargs tests/input "cat -u -b -e" "cat -v -b -e" "cat -v -b -e" tests/output
errorclean
sleep $SLEEP

# Test 46
printf "\e[1;36mTest 46: Running pipex with empty commands\e[0;00m\n"
./pipex tests/input "" "" "" tests/output 2> tests/error
if [ $? -eq 127 ]
then
	printf "\e[1;32mReturn value OK\e[0;00m\n"
...
# Test 47
printf "\e[1;36mTest 47: Running pipex with space commands\e[0;00m\n"
./pipex tests/input " " " " " " tests/output 2> tests/error
RTRN=$?
< tests/input " " 2> /dev/null | " " 2> /dev/null | " " > tests/expected 2> /dev/null
if [ 127 -eq $RTRN ]
...
# Test 48
printf "\e[1;36mTest 48: Running pipex with double quotes\e[0;00m\n"
fiveargs tests/input "echo ""hallo hallo"""  "echo ""hallo hallo""" "echo ""hallo hallo""" tests/output
errorclean
sleep $SLEEP

# Test 49
printf "\e[1;36mTest 49: Running pipex with single quotes\e[0;00m\n"
fiveargs tests/input 'echo ''hallo hallo''' 'echo ''hallo hallo''' 'echo ''hallo hallo''' tests/output
errorclean
sleep $SLEEP

# Test 50
printf "\e[1;36mTest 50: Running pipex with double quotes in single quotes\e[0;00m\n"
fiveargs tests/input 'echo "hallo hallo"' 'echo "hallo hallo"' 'echo "hallo hallo"' tests/output
errorclean
sleep $SLEEP

# Test 51
printf "\e[1;36mTest 51: Running pipex with single quotes in double quotes\e[0;00m\n"
fiveargs tests/input "echo 'hallo hallo'" "echo 'hallo hallo'" "echo 'hallo hallo'" tests/output
errorclean
sleep $SLEEP

# Test 52
printf "\e[1;36mTest 52: Running pipex with Absolute paths\e[0;00m\n"
...
# Test 53
cp $CATLOC tests/cat
printf "\e[1;36mTest 53: Running pipex with Relative paths\e[0;00m\n"
fiveargs tests/input "tests/cat" "tests/cat" "tests/cat" tests/output
errorclean
sleep $SLEEP

# Test 54
printf "\e[1;36mTest 54: Running pipex with backticks\e[0;00m\n"
...
# Test 55
printf "\e[1;36mTest 55: Running pipex with \$()\e[0;00m\n"
fiveargs tests/input "$(cat tests/cmd)" "$(echo cat)" "$(cat tests/cmd)" tests/output
errorclean
sleep $SLEEP

# Test 56
printf "\e[1;36mTest 56: Running pipex with non existing input\e[0;00m\n"
fiveargs doesnotexist "cat" "cat" "cat" tests/output
errorsuchfile 1
sleep $SLEEP

# Test 57
printf "\e[1;36mTest 57: Running pipex with nonexisting command 1\e[0;00m\n"
fiveargs tests/input "doesnotexist" "cat" "cat" tests/output
errornotfound 1
sleep $SLEEP

# Test 58
printf "\e[1;36mTest 58: Running pipex with nonexisting command 2\e[0;00m\n"
fiveargs tests/input "cat" "doesnotexist" "cat" tests/output
errornotfound 1
sleep $SLEEP

# Test 59
printf "\e[1;36mTest 59: Running pipex with nonexisting command 3\e[0;00m\n"
fiveargs tests/input "cat" "cat" "doesnotexist" tests/output
errornotfound 1
sleep $SLEEP

# Test 60
printf "\e[1;36mTest 60: Running pipex with nonexisting command 1, 2 & 3\e[0;00m\n"
fiveargs tests/input "doesnotexist" "doesnotexist" "doesnotexist" tests/output
errornotfound 3
sleep $SLEEP

# Test 61
printf "\e[1;36mTest 61: Running pipex with nonexisting input and command 1 \e[0;00m\n"
fiveargs doesnotexist "doesnotexist" "cat" "cat" tests/output
errorsuchfile 1
sleep $SLEEP

# Test 62
printf "\e[1;36mTest 62: Running pipex with nonexisting option 1\e[0;00m\n"
fiveargs tests/input "cat -r" "cat" "cat" tests/output
errorinvalid 1
sleep $SLEEP

# Test 63
printf "\e[1;36mTest 63: Running pipex with nonexisting option command 3\e[0;00m\n"
fiveargs tests/input "cat" "cat" "cat -r" tests/output
errorinvalid 1
sleep $SLEEP

# Test 64
printf "\e[1;36mTest 64: Running pipex with nonexisting option command 1, 2 & 3\e[0;00m\n"
fiveargs tests/input "cat -r" "cat -r" "cat -r" tests/output
errorinvalid 3
sleep $SLEEP

# Test 65
printf "\e[1;36mTest 65: Running pipex with no read permissions on input\e[0;00m\n"
fiveargs tests/perm "cat" "cat" "cat" tests/output
errorpermdenied 1
sleep $SLEEP

# Test 66
printf "\e[1;36mTest 66: Running pipex with no write permissions on existing output\e[0;00m\n"
...
# Test 67
printf "\e[1;36mTest 67: Running pipex with no execute permissions on command 1\e[0;00m\n"
fiveargs tests/input tests/perm cat cat tests/output
errorpermdenied 1
sleep $SLEEP

# Test 68
printf "\e[1;36mTest 68: Running pipex with no execute permissions on command 2\e[0;00m\n"
fiveargs tests/input cat tests/perm cat tests/output
errorpermdenied 1
sleep $SLEEP

# Test 69
printf "\e[1;36mTest 69: Running pipex with no execute permissions on command 3\e[0;00m\n"
fiveargs tests/input cat cat tests/perm tests/output
errorpermdenied 1
sleep $SLEEP

# Test 70
printf "\e[1;36mTest 70: Running pipex with no execute permissions on command 1, 2 & 3\e[0;00m\n"
fiveargs tests/input tests/perm tests/perm tests/perm tests/output
errorpermdenied 3
sleep $SLEEP

# Test 71
printf "\e[1;36mTest 71: Running pipex with no execute permissions on command 1 and input\e[0;00m\n"
fiveargs tests/perm tests/perm cat cat tests/output
errorpermdenied 1
sleep $SLEEP

# Test 72
printf "\e[1;36mTest 72: Running pipex with no execute permissions on command 3 and input\e[0;00m\n"
fiveargs tests/perm cat cat tests/perm tests/output
errorpermdenied 2
sleep $SLEEP

# Test 73
printf "\e[1;36mTest 73: Running pipex with heredoc empty lines\e[0;00m\n"
...
# Test 74
printf "\e[1;36mTest 74: Running pipex with heredoc space before and after delimiter\e[0;00m\n"
...
# Test 75
printf "\e[1;36mTest 75: Running pipex with too much file descriptors\e[0;00m\n"
if [ $OS == "Linux" ]
then
...
# Test 76
printf "\e[1;36mTest 76: Running pipex with all wrong options except the last\e[0;00m\n"
...
# Test 77
printf "\e[1;36mTest 77: Running pipex with 3 sleep commands\e[0;00m\n"
(time < tests/input sleep 1 | sleep 1 > tests/expected) 2>&1 > /dev/null | grep real | awk '{print substr($0,6,4);}' > tests/timereal
(time ./pipex tests/input "sleep 1" "sleep 1" tests/output) 2>&1 > /dev/null | grep real | awk '{print substr($0,6,4);}' > tests/timepipe
diff tests/timereal tests/timepipe
if [ $? -eq 0 ]
